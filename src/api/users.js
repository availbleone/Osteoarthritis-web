...
//常规登入
// http://192.168.136.217/ljService/WebApi/ljService
...
export let loginApi = (username, password) => {
  ...
  let userinfo = `
        <Request>
            <ServiceCode>lj.WARDCAMS.LOGON</ServiceCode>
            <TransNo>0</TransNo>
            <ParamList>
...
export let getbedsApi = (areaid) => {
  ...
  let bedsinfo = `
        <Request>
            <ServiceCode>lj.WARDCAMS.NURSE</ServiceCode>
            <TransNo>4</TransNo>
            <ParamList>
...
export let getprojectsApi = (count = -1, page = 1, areaid) => {
  ...
  let projectsinfo = `
    <Request>
        <ServiceCode>lj.WARDCAMS.Exam</ServiceCode>
        <TransNo>0</TransNo>
        <ParamList>
        <AreaId>${areaid}</AreaId>
...
export let changeBPApi = (areaid, bpnumbers, userid) => {
  ...
  let changeBPinfo = `
    <Request>
        <ServiceCode>lj.WARDCAMS.Tel</ServiceCode>
        <TransNo>1</TransNo>
        <ParamList>
            <AreaId>${areaid}</AreaId>
            <Phone>
